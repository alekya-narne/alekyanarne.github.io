...
!function(e, t, n, o) {
    ...
    e.extend(i.prototype, {
        ...
        wrapInner: function(e, t) {
            ...
            if (t = t || "", !(e.length && e.length < 1))
                for (e.length === o && (e = [e]), a = e.length - 1; a >= 0; a--) {
                    for (i = e[a], (r = n.createElement("div")).setAttribute("class", t); i.childNodes.length;)
            ...
            requestAnimationFrame(function() {
                var i = t.find("img").map(function(t, n) {
                        if (n.hasAttribute("width") && n.hasAttribute("height")) {
                            if (n.style.width = n.getAttribute("width") + "px", n.style.height = n.getAttribute("height") + "px", n.hasAttribute("data-cbp-src"))
                                return null;
                            if (null === o.checkSrc(n))
                                o.removeAttrImage(n);
                            else {
                                var i = e("<img>");
        ...
        resizeEvent: function() {
            ...
            i["private"].resize.initEvent({
                ...
                fn: function() {
                    ...
                    t && e.width !== t && (e.width = t, "alignCenter" === e.options.gridAdjustment && (e.wrapper[0].style.maxWidth = ""), e.layoutAndAdjustment(), e.triggerEvent("resizeGrid")),
        ...
        responsiveLayout: function() {
            ...
            t.blocks.each(function(n, o) {
                ...
                i.height = r,
                i.heightAndGap = r + t.options.gapHorizontal
            })
        },
        ...
        resizeMainContainer: function() {
            ...
            a !== n.height ? (n.obj.style.height = a + "px", n.height !== o && (i["private"].modernBrowser ? n.$obj.one(i["private"].transitionend, function() {
        ...
        triggerEvent: function(e, t) {
            ...
            if (i.registeredEvents[e])
                for (n = 0, o = i.registeredEvents[e].length; n < o; n++)
                    ...
                    i.registeredEvents[e][n].oneTime && (i.registeredEvents[e].splice(n, 1), n--, o--)
        },
        addItems: function(t, n, o) {
            var a = this;
            a.wrapInner(t, "cbp-item-wrapper"),
            a.$ul[o](t.addClass("cbp-item-loading").css({
                top: "100%",
                left: 0
            })),
            ...
            t.each(function(t, n) {
                o.blocks.each(function(t, a) {
                    if (n === a) {
                        var r = e(a);
                        o.blocks.splice(t, 1),
                        i["private"].modernBrowser ? (r.one(i["private"].animationend, function() {
                            r.remove()
    ...
    e.fn.cubeportfolio = function(e, t, n) {
        return this.each(function() {
            ...
            if (i["public"][e])
                return i["public"][e].call(this, t, n);
    ...
    e.extend(i.prototype, {
        ...
        mosaicLayout: function() {
            for (var e = this, t = 0, n = e.blocksOn.length; t < n; t++) {
                ...
                if (null === o)
                    return e.mosaicLayoutReset(), e.blocksAreSorted = !0, e.sortBlocks(e.blocksOn, "widthAndGap", "heightAndGap", !0), void e.mosaicLayout();
        ...
        getSpaceIndexAndBlock: function() {
            ...
            return e.each(t.freeSpaces, function(o, i) {
                ...
                return t.blocksOn.each(function(t, s) {
                    var l = e(s).data("cbp");
                    if (!0 !== l.pack)
                        return l.widthAndGap <= a && l.heightAndGap <= r ? (l.pack = !0, n = {
                            spaceIndex: o,
                            dataBlock: l
        ...
        generateF1F2: function(e, t) {
            ...
            i.leftEnd > i.leftStart && i.topEnd > i.topStart && (n.freeSpaces.splice(e, 0, i), e++),
            a.leftEnd > a.leftStart && a.topEnd > a.topStart && n.freeSpaces.splice(e, 0, a)
        },
        ...
        correctSubPixelValues: function() {
            ...
            for (e = 0, t = i.freeSpaces.length - 1; e < t; e++)
                n = i.freeSpaces[e],
                (o = i.freeSpaces[e + 1]).topStart - n.topStart <= 1 && (o.topStart = n.topStart)
        },
        ...
        uniqueFreeSpaces: function() {
            ...
            e.each(t.freeSpaces, function(t, o) {
                e.each(n, function(e, t) {
                    if (t.leftStart === o.leftStart && t.leftEnd === o.leftEnd && t.topStart === o.topStart && t.topEnd === o.topEnd)
                        return o = null, !1
                }),
                null !== o && n.push(o)
            }),
    ...
    i["private"] = {
        publicEvents: function(t, n, o) {
            ...
            i.initEvent = function(e) {
                0 === i.events.length && i.scrollEvent(),
                i.events.push(e)
            },
        ...
        browserInfo: function() {
            ...
            -1 !== a.indexOf("MSIE 8.") ? o.browser = "ie8" : -1 !== a.indexOf("MSIE 9.") ? o.browser = "ie9" : -1 !== a.indexOf("MSIE 10.") ? o.browser = "ie10" : t.ActiveXObject || "ActiveXObject" in t ? o.browser = "ie11" : /android/gi.test(a) ? o.browser = "android" : /iphone|ipad|ipod/gi.test(a) ? o.browser = "ios" : /chrome/gi.test(a) ? o.browser = "chrome" : o.browser = "",
            void 0 !== typeof o.styleSupport("perspective") && (e = o.styleSupport("transition"), o.transitionend = {
...
function(e, t, n, o) {
    ...
    i["public"] = {
        ...
        filter: function(t, n) {
            ...
            if (!a.isAnimating) {
                if (a.isAnimating = !0, e.isFunction(n) && a.registerEvent("filterFinish", n, !0), e.isFunction(t)) {
                    ...
                    a.defaultFilter = t,
                    o = a.filterConcat(a.defaultFilter)
                }
        ...
        layout: function(t) {
            ...
            n.isAnimating || n.width <= 0 ? e.isFunction(t) && t.call(n) : ("alignCenter" === n.options.gridAdjustment && (n.wrapper[0].style.maxWidth = ""), n.storeData(n.blocks), n.layoutAndAdjustment(), e.isFunction(t) && t.call(n))
        }
    }
}(jQuery, window, document),
function(e, t, n, o) {
    ...
    e.extend(i.prototype, {
        updateSliderPagination: function() {
            ...
            if (o.options.showPagination) {
                for (t = Math.ceil(o.blocksOn.length / o.cols), o.navPagination.empty(), n = t - 1; n >= 0; n--)
                    e("<div/>", {
        ...
        goToSlider: function() {
            var e = this;
            e.enableDisableNavSlider(),
            e.updateSliderPosition()
        },
        ...
        enableDisableNavSlider: function() {
            ...
            n.options.showPagination && (e = n.options.scrollByPage ? Math.ceil(n.sliderActive / n.cols) : n.isEndSlider() ? n.navPaginationItems.length - 1 : Math.floor(n.sliderActive / n.cols), n.navPaginationItems.removeClass("cbp-nav-pagination-active").eq(e).addClass("cbp-nav-pagination-active")),
            n.customPagination && (e = n.options.scrollByPage ? Math.ceil(n.sliderActive / n.cols) : n.isEndSlider() ? n.customPaginationItems.length - 1 : Math.floor(n.sliderActive / n.cols), n.customPaginationItems.removeClass(n.customPaginationClass).eq(e).addClass(n.customPaginationClass))
        },
        ...
        updateSliderPosition: function() {
            ...
            i["private"].modernBrowser ? e.$ul[0].style[i["private"].transform] = "translate3d(" + t + "px, 0px, 0)" : e.$ul[0].style.left = t + "px",
        ...
        dragSlider: function() {
            ...
            function r(e) {
                ...
                m = !0,
                0 !== u ? (d.one("click.cbp", function(e) {
                    return !1
                }), requestAnimationFrame(function() {
            ...
            function s(e) {
                ...
                i["private"].modernBrowser ? b.$ul[0].style[i["private"].transform] = "translate3d(" + t + "px, 0px, 0)" : b.$ul[0].style.left = t + "px"
            }
            function l() {
            ...
            var c,
                ...
                w = !1;
            b.isDrag = !1,
            "ontouchstart" in t || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 ? (y = {
...
function(e, t, n, o) {
    ...
    i.prototype.filterLayout = function() {
        ...
        n.blocksOff2On = n.blocksOn.filter(".cbp-item-off").removeClass("cbp-item-off").addClass("cbp-item-off2on").each(function(t, n) {
            var o = e(n).data("cbp");
            n.style.left = o.leftNew + "px",
            n.style.top = o.topNew + "px"
        }),
        n.blocksOn2Off.length ? n.blocksOn2Off.last().data("cbp").wrapper.one(a["private"].animationend, t) : n.blocksOff2On.length ? n.blocksOff2On.last().data("cbp").wrapper.one(a["private"].animationend, t) : n.blocksOn2On.length ? n.blocksOn2On.last().one(a["private"].transitionend, t) : t(),
...
function(e, t, n, o) {
    ...
    i.prototype.filterLayout = function() {
        function t() {
            ...
            "sequentially" === n.options.animationType && n.blocksOn.each(function(t, n) {
    ...
    i.prototype.filterLayout = function() {
        ...
        requestAnimationFrame(function() {
            ...
            n.blocksOn.removeClass("cbp-item-off").each(function(t, n) {
                ...
                n.style.left = o.left + "px",
                n.style.top = o.top + "px",
                o.wrapper[0].style[a["private"].animationDelay] = 50 * t + "ms"
            });
            var o = n.blocksOn.length,
                r = i.length;
            0 === o && 0 === r ? t() : o < r ? i.last().children(".cbp-item-wrapper").one(a["private"].animationend, t) : n.blocksOn.last().data("cbp").wrapper.one(a["private"].animationend, t),
            n.resizeMainContainer()
        })
    },
    i.prototype.destroy = function() {
            ...
            t.$obj.on("click.cbp", ".cbp-caption-defaultWrap", function(n) {
                if (n.preventDefault(), !t.isAnimating) {
                    ...
                    t.$obj.one("pluginResize.cbp", function() {
                        ...
                        0 === r.height && (a.removeClass("cbp-caption-expand-open"), i.attr("style", ""))
                    }),
...
function(e, t, n, o) {
        ...
        t.registerEvent("resetFiltersVisual", function() {
            ...
            n.filters.each(function(t, n) {
                ...
                e.each(o, function(e, t) {
                    ...
                    if (n.length)
                        return n.addClass("cbp-filter-item-active").siblings().removeClass("cbp-filter-item-active"), o.splice(e, 1), !1
                })
            }),
    ...
    i.prototype.filtersCallback = function(t, n) {
        e.isEmptyObject(t) || (t.wrap.trigger("mouseleave.cbp"), t.headerText ? t.headerText = "" : t.header.html(n.html())),
    ...
    i.prototype.destroy = function() {
        var e = this;
        e.filters.find(".cbp-filter-item").off(".cbp"),
        e.wrap.off(".cbp")
    },
...
function(e, t, n, o) {
    ...
    function a(e) {
        ...
        e.hasClass("cbp-slider-inline-ready") || (e.addClass("cbp-slider-inline-ready"), t.items = e.find(".cbp-slider-wrapper").children(".cbp-slider-item"), t.active = t.items.filter(".cbp-slider-item--active").index(), t.total = t.items.length - 1, t.updateLeft(), e.find(".cbp-slider-next").on("click.cbp", function(e) {
            e.preventDefault(),
            t.active < t.total ? (t.active++, t.updateLeft()) : t.active === t.total && (t.active = 0, t.updateLeft())
        }), e.find(".cbp-slider-prev").on("click.cbp", function(e) {
            e.preventDefault(),
            t.active > 0 ? (t.active--, t.updateLeft()) : 0 === t.active && (t.active = t.total, t.updateLeft())
        }))
    }
    var r = {},
...
function(e, t, n, o) {
    ...
    i.prototype.removeLazyLoad = function(t, n, o) {
        ...
        o && (r["private"].modernBrowser ? e(t).one(r["private"].transitionend, function() {
...
function(e, t, n, o) {
    ...
    function i(t) {
        ...
        0 !== n.loadMore.length && (n.loadItems = n.loadMore.find(".cbp-l-loadMore-loadItems"), "0" === n.loadItems.text() && n.loadMore.addClass("cbp-l-loadMore-stop"), t.registerEvent("filterStart", function(e) {
    ...
    i.prototype.click = function() {
        ...
        t.loadMore.on("click.cbp", function(n) {
            n.preventDefault(),
            t.parent.isAnimating || t.loadMore.hasClass("cbp-l-loadMore-stop") || (t.loadMore.addClass("cbp-l-loadMore-loading"), t.populateItems().then(function() {
    ...
    i.prototype.destroy = function() {
        ...
        r["private"].loadMoreScroll && r["private"].loadMoreScroll.destroyEvent(this)
    },
...
function(e, t, n, o) {
    ...
    var a = e.fn.cubeportfolio.constructor,
        ...
        s = {
                    ...
                    if (a.createMarkup(), "singlePage" === o) {
                        if (a.cubeportfolio.registerEvent("resizeWindow", function() {
                            ...
                            if (e.each(s, function(t, n) {
                                ...
                                d.setAttribute("href", s[0]),
                                a.openSinglePage([d], d)
                            }
                        }
            ...
            createMarkup: function() {
                var t = this,
                    o = "";
                "singlePage" === t.type && "left" !== t.options.singlePageAnimation && (o = " cbp-popup-singlePage-" + t.options.singlePageAnimation),
                t.wrap = e("<div/>", {
                ...
                "ie8" === a["private"].browser && (t.bg = e("<div/>", {
                    "class": "cbp-popup-ie8bg",
                    "data-action": "lightbox" === t.type ? "close" : ""
                }).appendTo(t.wrap)),
                "singlePage" === t.type && !1 === t.options.singlePageStickyNavigation ? t.navigationWrap = e("<div/>", {
                ...
                "singlePage" === t.type && (t.options.singlePageCounter && (t.counter = e(t.options.singlePageCounter).appendTo(t.navigation), t.counter.text("")), t.content.on("click.cbp", t.options.singlePageDelegate, function(e) {
                    e.preventDefault();
                    var o,
                        i,
            ...
            openLightbox: function(o, i) {
                var a,
                    ...
                    c = [];
                if (!s.isOpen) {
                    if (l = !0, s.isOpen = !0, s.stopEvents = !1, s.dataArray = [], s.current = null, null === (a = i.getAttribute("href")))
                    ...
                    e.each(o, function(t, n) {
                        ...
                        if (-1 === e.inArray(i, c)) {
                            ...
                            if (/youtu\.?be/i.test(i)) {
                                ...
                                r = "//www.youtube.com/embed/" + (o = o.replace(/\?|&/, "?")),
                                l = "isYoutube"
                            } else
                                /vimeo\.com/i.test(i) ? (o = i.substring(i.lastIndexOf("/") + 1), /autoplay=/i.test(o) || (o += "&autoplay=1"), r = "//player.vimeo.com/video/" + (o = o.replace(/\?|&/, "?")), l = "isVimeo") : /www\.ted\.com/i.test(i) ? (r = "http://embed.ted.com/talks/" + i.substring(i.lastIndexOf("/") + 1) + ".html", l = "isTed") : /soundcloud\.com/i.test(i) ? (r = i, l = "isSoundCloud") : /(\.mp4)|(\.ogg)|(\.ogv)|(\.webm)/i.test(i) ? (r = -1 !== i.indexOf("|") ? i.split("|") : i.split("%7C"), l = "isSelfHostedVideo") : /\.mp3$/i.test(i) && (r = i, l = "isSelfHostedAudio");
                            s.dataArray.push({
                                src: r,
            ...
            openSinglePage: function(o, i) {
                var r,
                    ...
                    p = [];
                if (!s.isOpen) {
                    if (s.cubeportfolio.singlePageInline && s.cubeportfolio.singlePageInline.isOpen && s.cubeportfolio.singlePageInline.close(), s.isOpen = !0, s.stopEvents = !1, s.dataArray = [], s.current = null, null === (r = i.getAttribute("href")))
                        throw new Error("HEI! Your clicked element doesn't have a href attribute.");
                    if (e.each(o, function(t, n) {
                        var o = n.getAttribute("href");
                        -1 === e.inArray(o, p) && (r === o && (s.current = l), s.dataArray.push({
                            url: o,
                            element: n
                        }), l++),
                        p.push(o)
            ...
            openSinglePageInline: function(n, o, i) {
                ...
                if (i = i || !1, l.fromOpen = i, l.storeBlocks = n, l.storeCurrentBlock = o, l.isOpen)
                    return r = l.cubeportfolio.blocksOn.index(e(o).closest(".cbp-item")), void (l.dataArray[l.current].url !== o.getAttribute("href") || l.current !== r ? l.cubeportfolio.singlePageInline.close("open", {
                        blocks: n,
                        currentBlock: o,
                        fromOpen: !0
                    }) : l.close());
                if (l.isOpen = !0, l.stopEvents = !1, l.dataArray = [], l.current = null, null === (a = o.getAttribute("href")))
                    throw new Error("HEI! Your clicked element doesn't have a href attribute.");
                if (s = e(o).closest(".cbp-item")[0], n.each(function(e, t) {
                    ...
                    url: a,
                    element: o
                }, e(l.dataArray[l.current].element).parents(".cbp-item").addClass("cbp-singlePageInline-active"), l.counterTotal = n.length, l.wrap.insertBefore(l.cubeportfolio.wrapper), l.topDifference = 0, "top" === l.options.singlePageInlinePosition)
                    l.blocksToMove = n,
                    l.top = 0;
            ...
            updateSinglePageIsOpen: function() {
                ...
                (e = t.content.find(".cbp-slider")).length ? (e.find(".cbp-slider-item").addClass("cbp-item"), t.slider = e.cubeportfolio({
                    layoutMode: "slider",
                    mediaQueries: [{
                        width: 1,
                        cols: 1
            ...
            createPinterestShare: function(e) {
                if (e.length && !e.attr("onclick")) {
                    ...
                    o && (n = o.src),
                    e.attr("onclick", "window.open('http://pinterest.com/pin/create/button/?url=" + encodeURIComponent(t.location.href) + "&media=" + n + "', '_blank', 'top=100,left=100,toolbar=0,status=0,width=620,height=400'); return false;")
                }
            },
            ...
            isImage: function(t) {
                ...
                n.cubeportfolio.loadImages(e('<div><img src="' + t.src + '"></div>'), function() {
                    n.updateImagesMarkup(t.src, t.title, n.getCounterMarkup(n.options.lightboxCounter, n.current + 1, n.counterTotal)),
                    n.tooggleLoading(!1)
                })
            },
            isVimeo: function(e) {
            ...
            updateSelfHostedVideo: function(e, t, n) {
                ...
                for (o = 0; o < e.length; o++)
                    /(\.mp4)/i.test(e[o]) ? a += '<source src="' + e[o] + '" type="video/mp4">' : /(\.ogg)|(\.ogv)/i.test(e[o]) ? a += '<source src="' + e[o] + '" type="video/ogg">' : /(\.webm)/i.test(e[o]) && (a += '<source src="' + e[o] + '" type="video/webm">');
            ...
            close: function(n, o) {
                ...
                function r() {
                    ...
                    s.resetWrap(),
                    e(t).scrollTop(o),
                    s.options.singlePageInlineInFocus && "promise" !== n ? e("html,body").animate({
    ...
    i.prototype.run = function() {
        var t = this,
            ...
            i = e(n.body);
        o.lightbox = null,
        o.options.lightboxDelegate && !p && (p = !0, o.lightbox = Object.create(s), o.lightbox.init(o, "lightbox"), i.on("click.cbp", o.options.lightboxDelegate, function(n) {
            n.preventDefault();
            var i = e(this),
        ...
        o.singlePage = null,
        o.options.singlePageDelegate && !c && (c = !0, o.singlePage = Object.create(s), o.singlePage.init(o, "singlePage"), i.on("click.cbp", o.options.singlePageDelegate, function(n) {
            n.preventDefault();
            var i = e(this),
        ...
        o.options.singlePageInlineDelegate && (o.singlePageInline = Object.create(s), o.singlePageInline.init(o, "singlePageInline"), o.$obj.on("click.cbp", o.options.singlePageInlineDelegate, function(t) {
            t.preventDefault();
...
function(e, t, n, o) {
    ...
    function i(t) {
        ...
        n.searchInput.siblings(".cbp-search-icon").on("click.cbp", function(t) {
            t.preventDefault(),
            n.runEvent.call(n, e(this).prev().val(""))
        })
    }
    var a = e.fn.cubeportfolio.constructor;
    i.prototype.runEvent = function(t) {
        ...
        i.value === o || n.parent.isAnimating || (i.value = o, o.length > 0 ? t.attr("value", o) : t.removeAttr("value"), n.parent.$obj.cubeportfolio("filter", function(t) {
            var r = t.filter(function(t, n) {
                if (e(n).find(i.el).text().search(a) > -1)
                    return !0
            });
...
function(e, t, n, o) {
    ...
    i.prototype.sliderMarkup = function() {
        ...
        }).appendTo(t.controls), t.controls.appendTo(t.nav)),
        t.options.showPagination && (t.navPagination = e("<div/>", {
            "class": "cbp-nav-pagination"
        }).appendTo(t.nav)),
        (t.controls || t.navPagination) && t.nav.appendTo(t.$obj),
        t.updateSliderPagination(),
        t.options.auto && (t.options.autoPauseOnHover && (t.mouseIsEntered = !1, t.$obj.on("mouseenter.cbp", function(e) {
            t.mouseIsEntered = !0,
            t.stopSliderAuto()
    ...
    i.prototype.destroy = function() {
        ...
        (e.parent.controls || e.parent.navPagination) && (e.parent.nav.off(".cbp"), e.parent.nav.remove())
    },
...
function(e, t, n, o) {
    ...
    function i(t) {
        ...
        0 !== n.element.length && (n.sort = "", n.sortBy = "string:asc", n.element.on("click.cbp", ".cbp-sort-item", function(o) {
            o.preventDefault(),
            n.target = o.target,
            e(n.target).hasClass("cbp-l-dropdown-item--active") || t.isAnimating || (n.processSort(), t.$obj.cubeportfolio("filter", t.defaultFilter))
    ...
    i.prototype.processSort = function() {
        ...
        if ("int" === a[0] ? r = "int" : "float" === a[0] && (r = "float"), "desc" === a[1] && (s = -1), t.sort) {
            ...
            var p = [];
            -1 === s && (n.blocks.each(function(t, n) {
